...
\begin{multicols}{2}
    ...
    experiments tend toward a preference towards many training iterations.
    ...
    As such, it seems there is no point in using $N > 2$.\footnote{It would be,
    ...
    \autoref{fig:rbm-onebody-inter} shows the one-body density that the learned
...
\begin{multicols}{2}
    ...
    as before, but a separate model for each value of $\omega$. The
    corresponding one-body density plots are shown in
    \autoref{fig:rbm-onebody-omegas}.
...
\end{multicols}
    ...
    \begin{tabular}{|c|c|c|c|c|c|}\hline
        $\omega$ & $\expval{E_L}$ & $SE_\expval{E_L}$ & $\expval{r_{12}}$ & $\expval{V_{pot}}$ &
        $\expval{K}$ \\\hline
        0.01 & 1.0876 &  0.00149 &  12.1 &  1.000 &  0.087\\
        0.05 & 1.0335 &  0.00129 &  6.46 &  0.833 &  0.201\\
        0.1  & 1.0183 &  0.00120 &  5.50 &  0.729 &  0.289\\
        0.5  & 1.8481 &  0.00111 &  2.32 &  0.726 &  1.121\\
        1.0  & 3.0779 &  0.00116 &  1.65 &  0.799 &  2.281\\\hline
    \end{tabular}
\end{table}
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{../results/onebody-omegas.png}
    \caption{One-body densities for selected values of $\omega$. The curve for
    $\omega=0.01$ is artificially highly peaked due to the way the curve is
    normalized, and cut off at a given radius.}
    \label{fig:rbm-onebody-inter}
\end{figure}
