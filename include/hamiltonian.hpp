...
class Hamiltonian {
    ...
    public:
         ...
         * @return Local energy evaluation.
         */
        virtual Real local_energy_numeric(const System& system, Wavefunction& wavefunction) const;
        /**
         ...
         * @return Kinetic energy evaluation.
         */
        virtual Real kinetic_energy_numeric(const System& system, Wavefunction& wavefunction) const;
        ...
        void optimize_wavefunction(Wavefunction& psi, Sampler& sampler, int iterations, int sample_points, SgdOptimizer& optimizer, Real gamma, bool verbose) const;
