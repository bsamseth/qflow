...
const delimiters_values<wchar_t>
    delimiters<::std::set<T, TComp, TAllocator>, wchar_t>::values = {L"{", L", ", L"}"};
...
struct custom_delims_wrapper : custom_delims_base
{
    ...
    {
        return s
               << print_container_helper<T, wchar_t, std::char_traits<wchar_t>, Delims>(
                      t);
    }
...
// Usage: std::cout << bucket_print(m, 4) << std::endl;  (Prints bucket 5 of container
// m.)
