...
public:
    ...
    virtual void SetUp()
    {
        ...
        rbm->set_parameters(
            {-0.7665546243072233, 0.9406054576757206,  -0.1411666581066846,
...
TEST_F(RBMWavefunctionTest, gradient)
{
    ...
    RowVector expected_a = vector_from_sequence({0.1328204908963744,
                                                 -0.4643882149287429,
                                                 0.6136752308048187,
                                                 -1.2439453044886151,
                                                 -0.4582921500616219,
                                                 0.142954682666936});
    RowVector expected_b = vector_from_sequence({0.6017040564983215,
                                                 0.6685085554779254,
                                                 0.8489820123505009,
                                                 0.2817462931894426,
                                                 0.2952675674909326,
                                                 0.2801418147825886,
                                                 0.7992927449865912});
    RowVector expected_w = vector_from_sequence(
        {-0.1507008853281547045,  -0.16743252778826867022, -0.21263333611787901822,
         -0.07056528099323740311, -0.07395177637413576088, -0.07016342843168088539,
         -0.20018832016331319923, 0.00355878701133167767,  0.00395390314973816364,
         0.00502131592063750822,  0.00166639236991122409,  0.00174636413483637842,
         0.00165690266005700778,  0.00472742805767981198,  0.32678060033525119232,
         0.36306158273163885442,  0.46107525564022888709,  0.153014130179683433,
         0.16035742475418299224,  0.15214275095038592989,  0.43408941693092562009,
         -0.03552034527934033042, -0.03946400968436082624, -0.0501178841806978817,
         -0.01663230537866778116, -0.01743050563445571605, -0.0165375883389716101,
         -0.04718458181322671835, -0.30359542440935755048, -0.33730226085350228926,
         -0.4283618359753899596,  -0.14215773440917583992, -0.14898002015876118942,
         -0.14134817978240585279, -0.40329065014738102457, -0.16141732875374550926,
         -0.17933876979699708842, -0.22775383864140447132, -0.07558322657416934043,
         -0.07921053796674140668, -0.07515279800105209573, -0.214423849057670729});
    for (int i = 0; i < M; ++i)
