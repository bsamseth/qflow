...
\begin{definition}{Symmetry Metric.}
    ...
    \begin{align}\label{eq:symmetry-metric-def}
        ...
        \sum_{\vb\alpha\in \mathcal{P}_n} P_{\vb\alpha}\Psi}^2}{\intfy\dd{\vb X}
        \max_{\vb\alpha\in \mathcal{P}} \abs{P_{\vb\alpha}\Psi}^2}
    \end{align}
\end{definition}
\begin{corollary}
...
\begin{proof}
    ...
    \begin{align}
        \abs{\frac{1}{n!} \sum_{\vb\alpha\in \mathcal{P}_n} P_{\vb\alpha}\Psi}^2
        \leq \max_{\vb\alpha\in \mathcal{P}} \abs{P_{\vb\alpha}\Psi}^2.
    \end{align}
