...
depth into how all this connects to VMC in~\cref{sec:reinf-learning-for-vmc}.
...
As mentioned, VMC is a type of reinforcement learning problem. While we don't
...
definition. When considering VMC in particular, we can treat it exactly the same
...
data to withhold. If a VMC calculation suddenly results in an amazingly accurate
