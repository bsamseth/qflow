...
\begin{table}[h]
  ...
  \caption[Ground state energies of the ideal harmonic oscillator]{\label{tab:verify-energy-estimates}Estimated ground state energy
    ...
    Blocking.\citesource{writing/scripts/verify-energy-stats.py}}
...
\begin{table}[h]
  ...
  \caption[Radial metrics of the ideal harmonic oscillator]{\label{tab:verify-radius-estimates}Estimates for the mean radial
    ...
    the corresponding integrals directly.\citesource{writing/scripts/verify-energy-stats.py}}
...
\begin{figure}[h]
  ...
  \caption[One-body density of the ideal harmonic oscillator]{\label{fig:verify-onebody}One-body density of a particle in a
    ...
    more samples. This result used $2^{23}$ MC samples.\citesource{writing/scripts/verify-onebody-density.py}}
\end{figure}
...
the exact result. This result used $2^{25}$ MC samples.\citesource{writing/scripts/verify-twobody-density.py}}
\end{figure}
...
\begin{figure}[h]
  ...
  \caption[Learning progression using VMC on the ideal harmonic oscillator]{\label{fig:verify-gaussian-simplest}Example training progression using $\psi_G$ as trial wave function.
