...
Second, we use an ansatz resulting from a Gaussian-binary \gls{rbm}, presented in \cref{eq:rbm-def}:
...
as the learning rate in \gls{sgd}. The following plots aim to illustrate this
