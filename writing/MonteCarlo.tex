...
the integers by $m$. The complete algorithm is shown in \autoref{alg:uniform-LCG-sampling}.
...
The algorithm to sample from any PDF with a tractable inverse cumulative distribution function is then extremely simple, and for completeness it is listed in \autoref{alg:inverse-transform-sampling}.
