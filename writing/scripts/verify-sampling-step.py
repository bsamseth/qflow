...
from qflow.mpi import master_rank, mpiprint
...
for step in tqdm(steps):
    ...
    semm.append(compute_statistics_for_series(H.local_energy_array(ms, psi, n_energy), method='blocking')['sem'])
    semi.append(compute_statistics_for_series(H.local_energy_array(si, psi, n_energy), method='blocking')['sem'])
...
if master_rank():
    ...
    ax1.legend([met, imp, met_sem, imp_sem], ["Metropolis AR", "Importance AR", "Metroplis SE", "Importance SE"], loc='upper left')
